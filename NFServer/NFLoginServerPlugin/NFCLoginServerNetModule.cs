//-----------------------------------------------------------------------
// <copyright file="NFCLoginServerNetModule.cs">
...
namespace NFrame
{
    class NFCLoginServerNetModule : NFILoginServerNetModule
    {
        ...
        public override void AfterInit()
        {
            ...
            if (xLogicClass != null)
            {
                ...
                foreach (string strConfigName in xNameList)
                {
                    ...
                    if (nServerType == (long)NFServer_def.NF_SERVER_TYPES.NF_ST_LOGIN && GetMng().GetAPPID() == nServerID)
                    {
