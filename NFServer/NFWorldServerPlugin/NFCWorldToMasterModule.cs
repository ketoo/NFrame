//-----------------------------------------------------------------------
// <copyright file="NFCWorldToMasterModule.cs">
...
namespace NFrame
{
    class NFCWorldToMasterModule : NFIWorldToMasterModule
    {
        ...
        public override void AfterInit()
        {
            ...
            if (xLogicClass != null)
            {
                ...
                foreach (string strConfigName in xNameList)
                {
                    ...
                    if (nServerType == (long)NFServer_def.NF_SERVER_TYPES.NF_ST_MASTER)
                    {
